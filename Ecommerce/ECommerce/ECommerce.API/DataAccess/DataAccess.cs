    ...
    public class DataAccess : IDataAccess
    {
        ...
        public bool InsertCategory(ProductCategory productCategory)
        {
            using (SqlConnection connection = new(dbconnection))
            {
                ...
                string query = "SELECT COUNT(*) FROM ProductCategories WHERE Category='" + productCategory.SubCategory + "';";
                command.CommandText = query;
                int count = (int)command.ExecuteScalar();
                if (count > 0)
                {
                ...
                query = "INSERT INTO ProductCategories (Category, SubCategory) values (@fn, @ln);";

                command.CommandText = query;
                command.Parameters.Add("@fn", System.Data.SqlDbType.NVarChar).Value = productCategory.Category;
                command.Parameters.Add("@ln", System.Data.SqlDbType.NVarChar).Value = productCategory.SubCategory;        
        ...
        public bool DeleteCategory(ProductCategory productCategory)
        {
            using (SqlConnection connection = new(dbconnection))
            {
                ...
                string query = "SELECT COUNT(*) FROM ProductCategories WHERE CategoryId='" + productCategory.Id + "';";
                command.CommandText = query;
                int count = (int)command.ExecuteScalar();
                if (count > 0)
                {
                    query = "DELETE FROM ProductCategories WHERE CategoryId = @fn;";

                    command.CommandText = query;
                    command.Parameters.Add("@fn", System.Data.SqlDbType.NVarChar).Value = productCategory.Id;
                    command.ExecuteNonQuery();
                    return true;
        ...
        public bool InsertProduct(Product product)
        {
            using (SqlConnection connection = new(dbconnection))
            {
                ...
                if (count > 0)
                {
                    query = "update Products set Quantity = '@qn' WHERE Title='" + product.Title + "';";
                    command.CommandText = query;
                    command.Parameters.Add("@qn", System.Data.SqlDbType.NVarChar).Value = product.Quantity;
                    command.ExecuteNonQuery();
                    return true;
                }

                query = "INSERT INTO Products (Title, Description, CategoryId, OfferId, Price, Quantity, ImageName) values (@fn, @ln, @pc, @of, @pr, @qn, @im) ;";
                ...
                command.Parameters.Add("@pc", System.Data.SqlDbType.NVarChar).Value = product.ProductCategory;
                command.Parameters.Add("@of", System.Data.SqlDbType.NVarChar).Value = product.Offer;
                command.Parameters.Add("@pr", System.Data.SqlDbType.NVarChar).Value = product.Price;
                command.Parameters.Add("@qn", System.Data.SqlDbType.NVarChar).Value = product.Quantity;
                command.Parameters.Add("@im", System.Data.SqlDbType.NVarChar).Value = product.ImageName;
