...
namespace ECommerce.API.Controllers
{
    ...
    public class ShoppingController : ControllerBase
    {
        ...
        //add cetegory by admin 
        [HttpPost("AddCategory")]
        public IActionResult AddCategory([FromBody]ProductCategory productCategory)
        {
            var result = dataAccess.InsertCategory(productCategory);
         
            return Ok(result);
        }
        //Delete cetegory by admin 
        [HttpPost("DeleteCategory")]
        public IActionResult DeleteCategory([FromBody] ProductCategory productCategory)
        {
            var result = dataAccess.DeleteCategory(productCategory);
